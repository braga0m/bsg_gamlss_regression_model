...
data40 <- read.table("Estimates_Scenario_1_2_n40.txt", h=T)
data80 <- read.table("Estimates_Scenario_1_2_n80.txt", h=T)
data160 <- read.table("Estimates_Scenario_1_2_n160.txt", h=T)
data320 <- read.table("Estimates_Scenario_1_2_n320.txt", h=T)
